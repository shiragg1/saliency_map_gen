...
saveas(gcf,"/media/Data/Attention_NN/matlab_models/CovSal/demo_fig.jpg")

normalizedSalMap = mat2gray(salmap2);
imwrite(normalizedSalMap,"/media/Data/Attention_NN/matlab_models/CovSal/sample_sal_map.jpg")
