...
for i = 1 : 5
  ...
  imwrite(saliency_map,'/media/Data/Attention_NN/matlab_models/GBVS/demo_salmap.png');
  normalizedSalMap = mat2gray(saliency_map);
  imwrite(normalizedSalMap,'/media/Data/Attention_NN/matlab_models/GBVS/demo_normsalmap.png');
